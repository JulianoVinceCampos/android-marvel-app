...
import com.example.marvelapp.framework.di.BaseUrlMode
...
@UninstallModules(BaseUrlMode::class)
@HiltAndroidTest
class CharactersFragmentTest {
    ...
    @Test
    fun shouldShowCharacters_whenWiewIsCreated() {
    ...
    @Test
    fun shouldShowErrorView_whenRecivesAnErrorFromApi() {
        //Arrange
